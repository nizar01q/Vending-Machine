...
public class MoneyTest {
    ...
    public void minusTest() {
        ...
        //assertThrows(IllegalArgumentException.class, () -> TenDinars.minus(OneDinar)); //---This will cause an error because (TenDinars - OneDinar) is a legal operation, so the exception will not be thrown.
